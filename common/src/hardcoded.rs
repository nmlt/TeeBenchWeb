...
pub fn hardcoded_profiling_jobs() -> Vec<Job> {
    let configs: Vec<ProfilingConfiguration> = Vec::from([
        ...
        // Version 2 vs. RHO
        ProfilingConfiguration {
            algorithms: HashSet::from([HjV2, Rho]),
            experiment_type: ExperimentType::Custom,
            parameter: Parameter::Algorithms,
            measurement: Measurement::Throughput,
            min: String::from("0"),
        ...
        ProfilingConfiguration {
            algorithms: HashSet::from([HjV2, HjV3]),
            experiment_type: ExperimentType::Custom,
            parameter: Parameter::Algorithms,
            measurement: Measurement::Throughput,
            min: String::from("0"),
        ...
        // Version 4 multi-threading
        ProfilingConfiguration {
            algorithms: HashSet::from([HjV4]),
            experiment_type: ExperimentType::Custom,
            parameter: Parameter::Threads,
            measurement: Measurement::Throughput,
            min: String::from("1"),
        ...
        // Version 4 multi-threading + context-switches
        ProfilingConfiguration {
            algorithms: HashSet::from([HjV4]),
            experiment_type: ExperimentType::Custom,
            parameter: Parameter::Threads,
            measurement: Measurement::ThroughputAndContextSwitches,
            min: String::from("1"),
            max: String::from("16"),
            step: String::from("1"),
            datasets: HashSet::from([Dataset::CacheFit]),
        ...
        // Version 4 and 5 multi-threading + context-switches
        ProfilingConfiguration {
            algorithms: HashSet::from([HjV4, HjV5]),
            experiment_type: ExperimentType::Custom,
            parameter: Parameter::Threads,
            measurement: Measurement::ThroughputAndContextSwitches,
            min: String::from("1"),
        ...
        // Version comparison
        ProfilingConfiguration {
            algorithms: HashSet::from([HjV2, HjV3, HjV4, HjV5]),
            experiment_type: ExperimentType::Custom,
            parameter: Parameter::Algorithms,
            measurement: Measurement::Throughput,
            min: String::from("0"),
