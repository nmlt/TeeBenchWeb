...
pub fn search_for_exp(
    ...
    let id = conn.query_row(
        &format!(
            ...
            query_none(&args.r_size, "r_size", 12),
            query_none(&args.s_size, "s_size", 13)
        ),
        arg_params,
    ...
    conn.query_row(
        ...
        |r| {
            ...
            map.insert(
                "threads".to_owned(),
                r.get::<usize, usize>(1).map(|v| v.to_string())?,
            );
            map.insert(
                "relR".to_owned(),
                r.get::<usize, usize>(2).map(|v| v.to_string())?,
            );
            map.insert(
                "relS".to_owned(),
                r.get::<usize, usize>(3).map(|v| v.to_string())?,
            );
            map.insert(
                "matches".to_owned(),
                r.get::<usize, usize>(4).map(|v| v.to_string())?,
            );
            map.insert(
                "phase1Cycles".to_owned(),
                r.get::<usize, usize>(5).map(|v| v.to_string())?,
            );
            map.insert(
                "phase2Cycles".to_owned(),
                r.get::<usize, usize>(6).map(|v| v.to_string())?,
            );
            map.insert(
                "cyclesPerTuple".to_owned(),
                r.get::<usize, usize>(7).map(|v| v.to_string())?,
            );
            map.insert(
                "phase1Time".to_owned(),
                r.get::<usize, usize>(8).map(|v| v.to_string())?,
            );
            map.insert(
                "phase2Time".to_owned(),
                r.get::<usize, usize>(9).map(|v| v.to_string())?,
            );
            map.insert(
                "totalTime".to_owned(),
                r.get::<usize, usize>(10).map(|v| v.to_string())?,
            );
            map.insert(
                "throughput".to_owned(),
                r.get::<usize, f64>(11).map(|v| v.to_string())?,
            );
